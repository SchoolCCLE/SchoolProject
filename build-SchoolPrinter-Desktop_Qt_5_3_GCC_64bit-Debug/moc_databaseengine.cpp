...
struct qt_meta_stringdata_Cartridges_t {
    QByteArrayData data[1];
    char stringdata[11];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_Cartridges_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_Cartridges_t qt_meta_stringdata_Cartridges = {
    {
QT_MOC_LITERAL(0, 0, 10)
    },
    "Cartridges"
...
static const uint qt_meta_data_Cartridges[] = {
...
void Cartridges::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    Q_UNUSED(_o);
    Q_UNUSED(_id);
    Q_UNUSED(_c);
...
const QMetaObject Cartridges::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_Cartridges.data,
      qt_meta_data_Cartridges,  qt_static_metacall, 0, 0}
};


const QMetaObject *Cartridges::metaObject() const
{
    return QObject::d_ptr->metaObject ? QObject::d_ptr->dynamicMetaObject() : &staticMetaObject;
}

void *Cartridges::qt_metacast(const char *_clname)
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_Cartridges.stringdata))
        return static_cast<void*>(const_cast< Cartridges*>(this));
    return QObject::qt_metacast(_clname);
}

int Cartridges::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    _id = QObject::qt_metacall(_c, _id, _a);
    if (_id < 0)
        return _id;
