...
#include "../SchoolPrinter/usercontroller.h"
...
QT_MOC_LITERAL(4, 37, 11)
    ...
    "UserController\0accessGranted\0\0access\0"
    "checkLoging"
};
...
void UserController::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->checkLoging((*reinterpret_cast< QString(*)>(_a[1])),(*reinterpret_cast< QString(*)>(_a[2]))); break;
        default: ;
        }
        ...
        {
            typedef void (UserController::*_t)(bool );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&UserController::accessGranted)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject UserController::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_UserController.data,
      qt_meta_data_UserController,  qt_static_metacall, 0, 0}
};
...
// SIGNAL 0
void UserController::accessGranted(bool _t1)
{
